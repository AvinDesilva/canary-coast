...
export default function ListingPanel({
  ...
  return (
    <div
      className={`flex-shrink-0 bg-twilight-indigo border-r-2 border-sapphire-sky flex flex-col h-full overflow-hidden transition-all duration-300 ${
    ...
    >
      ...
      {collapsed && (
        <div className="flex flex-col items-center py-3 gap-3 h-full">
          <button
            ...
            className="text-alice-blue/60 hover:text-fresh-sky transition-colors"
          ...
          <div
            className="font-fraunces text-xs font-bold text-alice-blue/40 tracking-widest select-none"
      ...
      {!collapsed && (
        <>
          <div className="px-4 py-3 border-b-2 border-sapphire-sky flex items-center justify-between flex-shrink-0">
          ...
          <div className="px-4 py-2 border-t-2 border-sapphire-sky text-alice-blue/30 flex-shrink-0" style={{ fontSize: "8px" }}>
