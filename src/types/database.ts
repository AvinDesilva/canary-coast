...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      census_tracts: {
        Row: {
          cancer_prevalence_pct: number | null
          cancer_sir_brain: number | null
          cancer_sir_breast: number | null
          cancer_sir_colon: number | null
          cancer_sir_lung: number | null
          cancer_sir_overall: number | null
